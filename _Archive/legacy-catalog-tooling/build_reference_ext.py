...
AMANI_DOMAIN_ALIAS = {
    ...
    'applications_browsing': ('SD-05', 'SD-05.01', 0.6, 1, 'apps(SD-05) vs browsing/web(SD-04.05); best-fit SDLC governance'),
    ...
    'financial_transactions': ('SD-02', 'SD-02.04', 0.5, 1, 'personal concept; best-fit data protection of financial data'),
    ...
    # enterprise codes (7)
    'GRC': ('SD-01', 'SD-01.01', 0.7, 1, 'Governance, Risk & Compliance; best-fit strategy & governance'),
    'IAM': ('SD-03', 'SD-03.03', 0.8, 0, 'Identity & Access Management'),
    'IPS': ('SD-04', 'SD-04.03', 0.6, 1, 'Infrastructure Protection & Security; best-fit config & hardening'),
    'DPP': ('SD-02', 'SD-02.04', 0.75, 0, 'Data Protection & Privacy'),
    'DMR': ('SD-06', 'SD-06.01', 0.6, 1, 'Detection, Monitoring & Response; best-fit logging & monitoring'),
