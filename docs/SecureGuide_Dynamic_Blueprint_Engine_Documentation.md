...
- `GeneratedBlueprint` مؤقت وغير سلطوي ولا يُحفظ في SQLite ولا يدخل التقرير الرسمي. تخزين `ApprovedBlueprint` وتحويله إلى مهام مرحلة لاحقة تتطلب ترحيلًا مستقلًا.
